...
<html>
    <head>
        ...
        <meta name="google-site-verification" content="0W5njWoJhg_KH3laIOv39L5m0Q3PHw0HjPTgyGBtItQ" />
    ...
    <body>
        ...
        <div class="info leftBox">
            ...
            <div class="infoText">
                ...
                <p>
                    ...
                    <a href="Pages/news.php">ProLog Books News</a> on how to get started with our site! Or check out our <a target="_blank" href="UserManual.pdf">User Manual</a>! 
        ...
        <div class="info rightBox">
            <div class="infoText">
                ...
                <p>On the <a href="Pages/collection.php">Collection</a> page, keep an inventory of all your books. The books stay in the order you add them so you 
        ...
        <div class="info leftBox">
            <div class="previewImage"><img src="Images/socialPreview.jpg?v=<?php echo time(); ?>"></div>
            <div class="infoText">
                <h2>Share Your Shelf!</h2>
                <p>Our <a href="Pages/social.php">Social</a> page is the best place to connect with other book lovers! Create a profile that 
        ...
        <div class="info rightBox">
            <div class="infoText">
                <h2>And More!</h2>
                <p>
                There's always new things to do coming out at ProLog Books! Stay connected with us (<a href="https://www.instagram.com/prologbooks/">@ProLogBooks</a> 
                on Instagram) for the latest news about the site! Check out our Ko-Fi page (<a href="https://ko-fi.com/prologbooks/">ProLog Books</a>) 
                if you want to donate to support us and get new features added sooner!
                </p>
            </div>
            <div class="previewImage"><img src="Images/kofiPreview.jpg?v=<?php echo time(); ?>"></div>
        </div>
